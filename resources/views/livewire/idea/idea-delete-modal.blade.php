...
"
x-init="
  window.livewire.on('ideadeleted',()=>{
...
<div
  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div 
    x-show.transition.duration-400ms="showDeleteModal"
    ...
    x-transition.duration:enter="ease-in duration-300"
    ...
    x-transition.duration:leave="ease-out duration-400"
    x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100"
    x-transition:leave-end="opacity-0 translate-y-full sm:scale-100"
          ...
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                Are you sure you want to Delete? All of the votes will be deleted permanently.
              </p>
            </div>
          </div>
        </div>
